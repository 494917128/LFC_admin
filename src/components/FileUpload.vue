<template>
  <div class="container-fluid">
    ...
    <div class="example-full">
      <button type="button" class="btn btn-danger float-right btn-is-option" @click.prevent="isOption = !isOption" v-if='false'>
        <i class="fa fa-cog" aria-hidden="true"></i>
        设置
      </button>
      <h1 id="example-title" class="example-title">Title</h1>
              ...
              <tr v-if="!files.length">
                <td colspan="7">
                  <div class="text-center p-5">
                    <h4>把文件放到任何地方上传<br/>或</h4>
                    <label :for="name" class="btn btn-lg btn-primary">选择文件</label>
                  </div>
                </td>
              </tr>
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item" href="#" v-if="file.active" @click.prevent="$refs.upload.update(file, {active: false})">终止</a>
                      <a class="dropdown-item" href="#" v-else-if="file.error && file.error !== 'compressing' && $refs.upload.features.html5" @click.prevent="$refs.upload.update(file, {active: true, error: '', progress: '0.00'})">重新上传</a>
                      <a :class="{'dropdown-item': true, disabled: file.success || file.error === 'compressing'}" href="#" v-else @click.prevent="file.success || file.error === 'compressing' ? false : $refs.upload.update(file, {active: true})">上传</a>

                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="#" @click.prevent="$refs.upload.remove(file)">删除</a>
                    </div>
                  </div>
                </td>
              </tr>
        ...
        <div class="example-foorer">
          ...
          <div class="btn-group">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item" href="#" @click.prevent="addData.show = true">添加数据</a>
            </div>
          </div>
