                ...
                <ul class="dropdown-menu dropdown-user">
                  <li>
                    <div class="user-box">
                      ...
                      <div class="u-text">
                        <h4>Hizrian</h4>
                        <p class="text-muted">hello@themekita.com</p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">退出登录</a>
                      </div>
                    </div>
                  </li>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="#"><i class="ti-user"></i>退出登录</a>
                </ul>
                <!-- /.dropdown-user -->
              </li>
            </ul>
          ...
          <ul class="nav">
            <template v-for="(item,index) in nav_list">
              <li :class="['nav-item',item.active?'active':'']">
                ...
                <router-link :to="{ path: item.link }" v-else>
                  <i class="la la-dashboard"></i>
                  <p>{{item.name}}</p>
                </router-link>
              </li>
